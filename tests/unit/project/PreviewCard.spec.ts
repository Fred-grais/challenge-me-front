...
describe('project/PreviewCard.vue', () => {
  ...
  it('should render the proper content', () => {
    ...
    expect(wrapper.find('span.from').text()).to.equal(
      `From ${projectPreview.ownerPreview.firstName} ${
        projectPreview.ownerPreview.lastName
      } (${projectPreview.ownerPreview.position})`,
    );
