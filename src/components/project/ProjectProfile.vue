<template>
  <div class="project-profile">
        ...
        <div class="container">
            <div class="media-container-row">
                <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-7">
                    <blockquote> <strong>From {{ currentProject.ownerFull.firstName }} {{ currentProject.ownerFull.lastName }} ({{ currentProject.ownerFull.position }})</strong> Mobirise vous aide à réduire le temps de développement en vous fournissant un éditeur de site Web flexible avec une interface glisser-déposer. Mobirise Website Builder crée un responsive, retina et <strong>Sites compatible mobile</strong> en quelques clics. Mobirise est l'un des outils de développement de sites Web les plus simples <a href="https://mobirise.com/">disponible</a> aujourd'hui. Il vous donne également la liberté de développer autant de sites que vous le souhaitez.</blockquote>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="media-container-row">
                <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                    <ol>
                        <li><strong>ADAPTÉ AU MOBILE</strong> - Aucune action spéciale requise, tous les sites que vous créez avec Mobirise sont adaptés aux mobiles. Vous n'avez pas besoin de créer une version spéciale mobile de votre site, elle s'adaptera automagiquement. <a href="https://mobirise.com/">Essayer maintenant !</a></li>
                        <li><strong>FACILE ET SIMPLE</strong> - Réduire le temps de développement avec l'éditeur de site Web glisser-déposer. Déposez les blocs dans la page, modifiez le contenu et publiez - aucune compétence technique requise. <a href="https://mobirise.com/">Essayer maintenant !</a></li>
                        <li><strong>STYLES UNIQUES</strong> - choisissez parmi une vaste sélection de blocs pré-faits - intro en plein écran, carrousel bootstrap, diapositive, galerie d'images adaptatif avec lightbox, défilement parallaxe, arrière-plans vidéo, menu hamburger, en-tête sticky et plus encore. <a href="https://mobirise.com/">Essayer maintenant !</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <!-- <div class="details" v-if="currentProject">
      ...
      <div>From {{ currentProject.ownerFull.firstName }} {{ currentProject.ownerFull.lastName }} ({{ currentProject.ownerFull.position }})</div>
    </div> -->
  </div>
</template>
...
export default class ProjectProfile extends Vue {
  ...
  @Getter('getFetchingState', { namespace: currentProjectNamespace }) fetchingProject!: boolean;

  @Action('fetchData', { namespace: currentProjectNamespace }) fetchData!: (projectId: number) => Promise<any>;
