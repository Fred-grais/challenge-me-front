        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">Inbox</h2>
                </div>
            </div>
        </div>
    </section>
      ...
      <div class="row row-broken">
        <div class="col-sm-3 col-xs-12">
          <div class="col-inside-lg decor-default chat" style="overflow: auto; outline: none;" tabindex="5000">
            <inbox-conversations-list v-on:fetch-conversation-details='fetchConversationDetails'></inbox-conversations-list>
          </div>
        </div>
...
export default class InboxLayout extends Vue {
  @Action('fetchConversationPreviews', { namespace: meInboxNamespace }) fetchConversationPreviews!: () => Promise<any>;
  @Action('fetchConversation', { namespace: meInboxNamespace }) fetchConversation!: (conversationId: number) => Promise<any>;

  created() {
    this.fetchConversationPreviews();
  }
